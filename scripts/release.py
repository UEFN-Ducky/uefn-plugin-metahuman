#!/usr/bin/env python3
"""Zip + publish metahuman to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1: MetaHuman skill + tools"
"""
...
def publish(zip_path: Path, *, category: str, changelog: str) -> None:
    ...
    release_args: dict = {
        ...
        "changelog": changelog,
        "publish": True,
        "categories": ["plugins", "mcps", "skills"],
        "tags": ["metahuman", "npc", "character", "mcp", "uefn"],
    }
    if file_id:
